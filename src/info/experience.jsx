const experience = [
    {
        ...
        description: [ "Led game development, e-learning, and web development projects for a USA-based client.", 
            ...
            "Implemented Scrum for project planning and execution.",
            "Acted as client liaison, ensuring satisfaction and timely updates."] 
    },
    {
        ...
        description: [
            ...
            "Developed skills in international recruiting and blockchain."]
    },
    {
        jobTitle: "Recruiter",
        company: "Solvo",
    ...
    },
    {
        ...
        description: ["Supervised social requirements in construction projects.",
            "Managed community interactions and compliance with regulations."]
    },
    {
        jobTitle: "Project Manager/ Social Worker",
        company: "Contractor",
